...
- `--extras` Скачивать дополнительные материалы (саундтреки, артбуки, обои и т.д.)
- `--check-updates` Повторно скачать файлы, если в GOG обновили игру (сравнивает MD5 с предыдущей загрузкой)
...
- Опциональная загрузка дополнительных материалов (extras)
- Проверка и перекачка обновлённых версий игр
